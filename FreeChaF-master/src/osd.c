...
// DJ: Display when a button is pressed
void OSD_drawConsoleButtonPress(int buttonIndex)
{

	int x = 20;
	int y = (DisplayHeight-16);

	switch (buttonIndex) {
		case 0:
		OSD_drawTextBoxed(x, y, "RESET");
		break;
		case 1:
		OSD_drawTextBoxed(x, y, "TIME");
		break;
		case 2:
		OSD_drawTextBoxed(x, y, "MODE");
		break;
		case 3:
		OSD_drawTextBoxed(x, y, "HOLD");
		break;
		case 4:
		OSD_drawTextBoxed(x, y, "START");
		break;
	}
}
...
void OSD_drawConsole(int pos, int down)
{
	...
	switch(pos)
	{
		case 0: OSD_drawTextCenterBoxed(DisplayHeight-26, "RESET"); 
		break;
		case 1:
